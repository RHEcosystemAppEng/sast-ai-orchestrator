...
import com.redhat.sast.ai.api.v1.dto.request.JobBatchSubmissionDto;
import com.redhat.sast.ai.api.v1.dto.response.JobBatchResponseDto;
import com.redhat.sast.ai.service.JobBatchService;
    ...
    public Response submitBatch(JobBatchSubmissionDto submissionDto) {
        try {
            ...
            return Response.status(Response.Status.BAD_REQUEST)
                    .entity("Error submitting batch: " + e.getMessage()).build();
        }
    }
    ...
    public Response getAllBatches(
        ...
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity("Error retrieving batches: " + e.getMessage()).build();
        }
    }
    ...
    public Response getBatchById(@PathParam("batchId") Long batchId) {
        try {
            ...
            return Response.status(Response.Status.NOT_FOUND)
                    .entity("Batch not found: " + e.getMessage()).build();
        } catch (Exception e) {
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity("Error retrieving batch: " + e.getMessage()).build();
        }
    }
} 