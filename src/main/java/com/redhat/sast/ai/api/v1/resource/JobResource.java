package com.redhat.sast.ai.api.v1.resource;

import com.redhat.sast.ai.api.v1.dto.request.JobCreationDto;
import com.redhat.sast.ai.api.v1.dto.response.JobResponseDto;
import com.redhat.sast.ai.enums.JobStatus;
import com.redhat.sast.ai.service.JobService;
...
public class JobResource {
    ...
    public Response createJob(
        ...
        try {
            ...
            return Response.status(Response.Status.NOT_IMPLEMENTED)
                    .entity("Multipart file upload endpoint not yet implemented. Use /simple endpoint for JSON-only job creation.")
                    .build();
        } catch (Exception e) {
            return Response.status(Response.Status.BAD_REQUEST)
                    .entity("Error creating job: " + e.getMessage()).build();
        }
    }
    ...
    public Response getAllJobs(
        ...
        try {
            ...
            return Response.status(Response.Status.BAD_REQUEST)
                    .entity("Invalid status parameter: " + e.getMessage()).build();
        } catch (Exception e) {
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity("Error retrieving jobs: " + e.getMessage()).build();
        }
    }
    ...
    public Response getJobById(@PathParam("jobId") Long jobId) {
        try {
            ...
            return Response.status(Response.Status.NOT_FOUND)
                    .entity("Job not found: " + e.getMessage()).build();
        } catch (Exception e) {
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity("Error retrieving job: " + e.getMessage()).build();
        }
    }
    ...
    public Response cancelJob(@PathParam("jobId") Long jobId) {
        try {
            ...
            return Response.status(Response.Status.BAD_REQUEST)
                    .entity("Cannot cancel job: " + e.getMessage()).build();
        } catch (Exception e) {
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity("Error cancelling job: " + e.getMessage()).build();
        }
    }
} 